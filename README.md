...
## Citation
This code has been copied from https://github.com/Jean-njoroge/Breast-cancer-risk-prediction.git for the purpose of training and learning I'm not the one who wrote  the code, just i made a bit of change.
